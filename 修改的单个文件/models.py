...
class Users(db.Model):
    ...
    # 与点赞表和差评表建立一对多关系
    u_raise = db.relationship('Raise',backref='user',lazy='dynamic')
    u_down = db.relationship('Down',backref='user',lazy='dynamic')
...
class Notes(db.Model):
    ...
    # 与点赞表和差评表建立一对多关系
    n_raise = db.relationship('Raise',backref='note',lazy='dynamic')
    n_down = db.relationship('Down',backref='note',lazy='dynamic')
